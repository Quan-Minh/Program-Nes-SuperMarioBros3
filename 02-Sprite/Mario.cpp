...
//void CBrick2::Render() {
//
//	LPANIMATION ani = CAnimations::GetInstance()->Get(511);
//
//	ani->Render(x, y);
//
//}

CBird::CBird(float x, float y, float vx) :CGameObject(x, y)
{
	this->vx = vx;
};

void CBird::Update(DWORD dt)
{
	x += vx * dt;
...
void CBird::Render() 
{
	...
	//[RED FLAG][TODO]: Student needs to think about how to associate this animation/asset to Mario!!
	if (vx > 0) ani = CAnimations::GetInstance()->Get(511);
